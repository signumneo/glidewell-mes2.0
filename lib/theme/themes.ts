...
export const themes: Record<ThemeName, Theme> = {
  light: {
    ...
    colors: {
      ...
      accentHover: 'hover:bg-blue-50/50',
      hoverBackground: 'hover:bg-gray-50/50',
  ...
  claude: {
    ...
    colors: {
      ...
      accentHover: 'hover:bg-[#c78850]/10',
      hoverBackground: 'hover:bg-[#c78850]/5',
  ...
  forest: {
    ...
    colors: {
      ...
      accentHover: 'hover:bg-[#2d6a3f]/10',
      hoverBackground: 'hover:bg-[#2d6a3f]/5',
  ...
  ocean: {
    ...
    colors: {
      ...
      accentHover: 'hover:bg-[#0369a1]/10',
      hoverBackground: 'hover:bg-[#0369a1]/5',
  ...
  sunset: {
    ...
    colors: {
      ...
      accentHover: 'hover:bg-[#7c3aed]/10',
      hoverBackground: 'hover:bg-[#7c3aed]/5',
